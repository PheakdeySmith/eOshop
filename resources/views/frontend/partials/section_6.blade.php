                ...
                <div class="products-carousel swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="product-item swiper-slide">
                            ...
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('front_assets') }}/images/thumb-tomatoes.png" class="tab-image">
                                </a>
                            </figure>
                        ...
                        <div class="product-item swiper-slide">
                            ...
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('front_assets') }}/images/thumb-tomatoketchup.png" class="tab-image">
                                </a>
                            </figure>
                            <h3>Sunstar Fresh Melon Juice</h3>
                            <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
                        ...
                        <div class="product-item swiper-slide">
                            ...
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('front_assets') }}/images/thumb-bananas.png" class="tab-image">
                                </a>
                            </figure>
                            <h3>Sunstar Fresh Melon Juice</h3>
